...
public class YouTube extends CordovaPlugin {
	...
	public static final String YOUTUBE_API_KEY = "AIzaSyAly-zlBK49dhzb0Zodbq3sbaHtXul8MkA";
	...
	private void doPlayVideo(JSONArray args) throws JSONException {
		...
		Intent youtubeIntent = YouTubeStandalonePlayer.createVideoIntent(this.cordova.getActivity(), YOUTUBE_API_KEY, videoid, 0, true, false);
